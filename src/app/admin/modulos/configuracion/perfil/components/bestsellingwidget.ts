...
@Component({
    ...
    template: ` <div class="card">
        <div class="flex justify-between items-center mb-6">
            ...
            <div>
                <button pButton type="button" icon="pi pi-ellipsis-v" class="p-button-rounded p-button-text p-button-plain" (click)="menu.toggle($event)" aria-label="Más opciones"></button>
