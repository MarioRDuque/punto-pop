...
export class LayoutService {
    /* ════════════════════════════════════════════════════════════════════
       Punto Pop · Aurora — defaults
       darkTheme: true      → arranca en modo oscuro (el look del canvas)
       primary:   'indigo'  → indigo/violeta como acción
       ════════════════════════════════════════════════════════════════════ */
    ...
    constructor() {
        /* Aurora: aplicar .app-dark inmediatamente para evitar
           flash de modo claro al cargar la app. */
        if (this._config.darkTheme && typeof document !== 'undefined') {
